...
public class MyntraWishListVerification {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		//clicking on wishlist to access the login page
		...
		Thread.sleep(50000);
		driver.findElement(By.cssSelector("[class='submitBottomOption']")).click(); // after click action provide the OTP Manually
		Thread.sleep(50000);
		//clicking on continue shopping to resume the shopping
		driver.findElement(By.cssSelector("[class=\"wishlistEmpty-button\"]")).click();
		Thread.sleep(5000);
		//searching the product (shirts)
		...
		//mouse hovering on the product to make the wishlist button to visible
